...
public class QuienesSomosControlador extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<Anio> Fecha = LLenarListaAnio();
        request.setAttribute("ListaFecha", Fecha);
    ...
    public String getServletInfo() {
     ...
     private ArrayList<Anio> LLenarListaAnio() {
        AnioDAO anio = new AnioDAO();
        ArrayList<Anio> a = (ArrayList<Anio>) anio.ListaAnio();
        return a;
    }
